...
const ROCWorks = () => (
  <>
    <SEO
      title="ROC Works"
      description="Registrar of Companies Works, refers to the administrative and regulatory activities carried out by the office of the Registrar of Companies (ROC)."
      keywords="roc works, company registration, compliance"
      canonicalUrl="https://yourdomain.com/services/other/roc-works"
    />
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-[#474544]/80 text-lg max-w-2xl mx-auto leading-relaxed">
            Registrar of Companies Works, refers to the administrative and
            regulatory activities carried out by the office of the Registrar of
            Companies (ROC).
          </p>
        </div>
      </div>
