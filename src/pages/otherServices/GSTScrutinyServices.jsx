...
const GSTScrutinyServices = () => {
  ...
  const checklist = [
    {
      title: "Notice from GST Department",
      desc: "Official notice received for scrutiny",
    },
    {
      title: "GST Registration Certificate",
      desc: "Proof of GST registration",
    },
    { title: "GST Returns", desc: "Filed returns for relevant periods" },
    {
      title: "Sales and Purchase Invoices",
      desc: "All invoices for the period",
    },
    { title: "Input Tax Credit Documents", desc: "Proofs for ITC claimed" },
    { title: "E-way Bills", desc: "If applicable, for goods movement" },
    { title: "Bank Statements", desc: "All bank accounts for the period" },
    {
      title: "Reconciliation Statements",
      desc: "GST vs. books reconciliation",
    },
    {
      title: "Correspondence with GST Dept",
    ...
    <div className="py-16 bg-[#F2F3EB]">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            Providing assistance and support to businesses and individuals
            during the scrutiny process conducted by the Goods and Services Tax
            (GST) authorities. GST scrutiny is a mechanism to ensure that
            taxpayers have complied with GST laws, reported their transactions
            accurately, and paid the correct amount of GST.
          </motion.p>
        </motion.div>
        {/* Checklist Section */}
        <motion.div
...
export default GSTScrutinyServices;
