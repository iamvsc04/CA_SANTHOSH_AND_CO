...
export default function PrivacyPolicy() {
  return (
    <>
      <Helmet>
        <title>
          Privacy Policy | CA VEERLAPATI Santhosh - Chartered Accountant
          Nalgonda
        </title>
        <meta
          name="description"
          content="Read our privacy policy regarding the collection, use, and protection of your personal information at CA VEERLAPATI Santhosh in Nalgonda."
        />
      </Helmet>
        ...
        <div className="container max-w-4xl mx-auto">
          <div className="space-y-8 text-secondary-700">
            ...
            >
              ...
              <p>
                This Privacy Policy describes how CA VEERLAPATI Santhosh
                collects, uses, and protects your personal information when you
                visit our website and use our services. By using our website or
            ...
            >
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                ...
                <li>Address</li>
                <li>
                  Any other information you voluntarily provide when contacting
                  us or booking an appointment.
                </li>
              </ul>
              <h4 className="text-lg font-medium text-secondary-800 mb-2 mt-4">
                Usage Data
              </h4>
              <p>
            ...
            >
              ...
              <p className="mb-4">
                CA VEERLAPATI Santhosh uses the collected data for various
                purposes:
              </p>
              <ul className="list-disc list-inside ml-4 space-y-1">
            ...
            >
              ...
              <p>
                ...
                contact us using the information on our Contact page or by email
