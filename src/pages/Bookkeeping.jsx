...
import { CheckCircleIcon, DocumentTextIcon, CalculatorIcon, ShieldCheckIcon, ChartBarIcon } from '@heroicons/react/24/outline';
...
export default function Bookkeeping() {
  ...
  const features = [
    {
      ...
      description: "Maintaining precise and up-to-date financial records for your business"
    },
    {
      icon: DocumentTextIcon,
      title: "Transaction Recording",
      description: "Detailed recording of sales, purchases, receipts, and payments"
    },
    {
      icon: ShieldCheckIcon,
      title: "Reconciliation Services",
      description: "Bank and credit card reconciliation to ensure accuracy"
    },
    {
      icon: ChartBarIcon,
      title: "Financial Reporting",
      description: "Generating customized financial reports for insights"
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Bookkeeping | CA VEERLAPATI Santhosh</title>
        <meta name="description" content="Expert bookkeeping services with comprehensive support and guidance from CA VEERLAPATI Santhosh in Nalgonda." />
      </Helmet>
          ...
          <div className="container relative z-10 text-center py-20">
            ...
            >
              ...
              <AnimatedText className="mt-4 text-lg md:text-xl text-white drop-shadow-md">
                Accurate, reliable, and timely bookkeeping to keep your financials in order
              </AnimatedText>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <div className="space-y-12">
              ...
              >
                ...
                <p className="leading-relaxed text-secondary-700 text-lg">
                  We offer comprehensive bookkeeping services tailored to the needs of your business. From daily transaction recording to monthly reconciliation and reporting, we ensure your financial records are accurate, organized, and compliant. Our goal is to provide you with the financial clarity needed to make informed business decisions.
                </p>
              </motion.div>
              ...
              >
                <h3 className="text-3xl font-bold text-primary-800 mb-6">Services Included</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {["Data Entry and Transaction Classification", "Accounts Payable Management", "Accounts Receivable Management", "Bank and Credit Card Reconciliations", "Payroll Processing Assistance", "Preparation of Financial Statements"].map((service, index) => (
                    <motion.div
                      key={index}
              ...
              <motion.div
                ...
                className="p-8 bg-gradient-to-br from-primary-50 to-white rounded-2xl shadow-xl border border-primary-100"
              >
                <h3 className="text-3xl font-bold text-primary-800 mb-6">Benefits of Professional Bookkeeping</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {["Clear Financial Overview", "Improved Decision Making", "Ensured Compliance", "Time and Cost Savings", "Simplified Tax Preparation", "Enhanced Business Efficiency"].map((benefit, index) => (
                    <motion.div
                      key={index}
              ...
              >
                <h3 className="text-3xl font-bold text-white mb-4">Get Your Bookkeeping Sorted</h3>
                <p className="text-primary-100 mb-8 max-w-2xl mx-auto">
                  Let us handle your bookkeeping so you can focus on growing your business. Contact us today or book an appointment to discuss your needs.
                </p>
                <Link to="/book-appointment">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
