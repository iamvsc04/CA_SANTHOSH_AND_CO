...
const GSTAudit = () => {
  return (
    <>
      <SEO
        title="Required Documents for GST Audit"
        description="Checklist of documents required for GST Audit. Ensure you have all necessary paperwork for a smooth audit process."
        keywords="gst audit, required documents, audit checklist, gst compliance"
        canonicalUrl="https://yourdomain.com/services/audit-services/gst-audit/required-documents"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-[#474544]/80 text-lg max-w-2xl mx-auto leading-relaxed">
              Please prepare the following documents for your GST Audit. Having
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {[
              ...
              "E-way Bills",
              "Previous Year GST Audit Report (if applicable)",
            ].map((item, idx) => (
              <motion.div
                key={idx}
          ...
          <div className="p-4 bg-[#474544]/5 rounded-lg mt-8 max-w-3xl mx-auto">
            <p className="text-[#474544] text-sm text-center">
              ...
              your business and GST audit requirements.
            </p>
          </div>
        </div>
      </div>
