    ...
    <div className="py-16 bg-[#F2F3EB]">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            Start your business journey with a legally recognized Limited Liability Partnership. We guide you through every step of the registration process, ensuring compliance with all regulatory requirements.
          </motion.p>
        </motion.div>
                    ...
                    >
                      ...
                      <div>
                        <h3 className="font-semibold text-[#474544]">{
                          num === 1 ? "LLP Names" :
                          num === 2 ? "LLP Objectives" :
                          num === 3 ? "Partner Photos" :
                          num === 4 ? "Partner PAN Cards" :
                          num === 5 ? "Partner ID Proof" :
                          "Contact Details"
                        }</h3>
                        <p className="text-[#474544]/70 text-sm">{
                          num === 1 ? "Proposed two LLP names (priority wise)" :
                          num === 2 ? "Objectives of the LLP" :
                          num === 3 ? "Passport size photos of all partners" :
                          num === 4 ? "PAN Cards of all partners" :
                          num === 5 ? "AADHAR/Voter ID/Passport/Driving License" :
                          "Mobile numbers and email IDs of all partners"
                        }</p>
                      </div>
                    </motion.div>
                  ))}
                ...
                <div className="space-y-4">
                  {[7, 8, 9, 10, 11].map((num) => (
                    ...
                    >
                      ...
                      <div>
                        <h3 className="font-semibold text-[#474544]">{
                          num === 7 ? "Bank Statement" :
                          num === 8 ? "Utility Bill" :
                          num === 9 ? "Rental Agreement/NOC" :
                          num === 10 ? "Profit Sharing" :
                          "Specimen Signatures"
                        }</h3>
                        <p className="text-[#474544]/70 text-sm">{
                          num === 7 ? "Recent one month bank statement of all partners" :
                          num === 8 ? "Recent electricity bill of company address" :
                          num === 9 ? "Rental agreement or NOC from owner" :
                          num === 10 ? "Profit sharing ratio among partners" :
