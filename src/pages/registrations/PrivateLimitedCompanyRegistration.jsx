    ...
    <div className="py-16 bg-[#F2F3EB]">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            Start your business journey with a legally recognized private limited company. We guide you through every step of the registration process, ensuring compliance with all regulatory requirements.
          </motion.p>
        </motion.div>
                    ...
                    >
                      ...
                      <div>
                        <h3 className="font-semibold text-[#474544]">{
                          num === 1 ? "Company Names" :
                          num === 2 ? "Company Objectives" :
                          num === 3 ? "Director Photos" :
                          num === 4 ? "Director PAN Cards" :
                          "Director ID Proof"
                        }</h3>
                        <p className="text-[#474544]/70 text-sm">{
                          num === 1 ? "Proposed two company names" :
                          num === 2 ? "Nature of business activities" :
                          num === 3 ? "Passport size photos of all directors" :
                          num === 4 ? "PAN Cards of all directors" :
                          "AADHAR/Voter ID/Passport/Driving License"
                        }</p>
                      </div>
                    </motion.div>
                  ))}
                ...
                <div className="space-y-4">
                  {[6, 7, 8, 9, 10].map((num) => (
                    ...
                    >
                      ...
                      <div>
                        <h3 className="font-semibold text-[#474544]">{
                          num === 6 ? "Contact Details" :
                          num === 7 ? "Bank Statement" :
                          num === 8 ? "Rental Agreement/NOC" :
                          num === 9 ? "Profit Sharing" :
                          "Specimen Signatures"
                        }</h3>
                        <p className="text-[#474544]/70 text-sm">{
                          num === 6 ? "Mobile numbers and email IDs of all directors" :
                          num === 7 ? "Recent one month bank statement of all directors" :
                          num === 8 ? "Rental agreement or NOC from owner" :
                          num === 9 ? "Profit sharing ratio for share allocation" :
                          "Specimen signatures of all directors"
                        }</p>
                      </div>
                    </motion.div>
                  ))}
