    ...
    <div className="py-16 bg-[#F2F3EB]">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            Start your business journey with a simple and straightforward proprietorship firm registration. We guide you through every step of the process, ensuring compliance with all regulatory requirements.
          </motion.p>
        </motion.div>
                    ...
                    >
                      ...
                      <div>
                        <h3 className="font-semibold text-[#474544]">{
                          num === 1 ? "Business Name" :
                          num === 2 ? "Business Objectives" :
                          num === 3 ? "Owner's Photo" :
                          num === 4 ? "Owner's PAN Card" :
                          "Owner's ID Proof"
                        }</h3>
                        <p className="text-[#474544]/70 text-sm">{
                          num === 1 ? "Proposed business name" :
                          num === 2 ? "Objectives of the business" :
                          num === 3 ? "Passport size photo of the owner" :
                          num === 4 ? "PAN Card of the owner" :
                  ...
                  {[6, 7, 8, 9, 10].map((num) => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[#474544]/70 text-sm">{
                          num === 6 ? "Mobile number and email ID of the owner" :
                          num === 7 ? "Recent one month bank statement" :
                          num === 8 ? "Recent electricity bill of business address" :
